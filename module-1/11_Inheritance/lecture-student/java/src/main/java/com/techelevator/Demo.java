...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("High bid for the shoes is " + firstAuction.getHighBid().getBidder());
        System.out.println("High bid on the shoes is " + firstAuction.getHighBid().getBidder());
        ...
        BuyoutAuction thirdAuction = new BuyoutAuction("Time Machines", 450);
        ...
        thirdAuction.placeBid(new Bid("Jason", 500));
        System.out.println("The winning bidder is currently: " + thirdAuction.getHighBid().getBidder());
